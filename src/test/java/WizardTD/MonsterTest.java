...
public class MonsterTest {
    ...
    public void testMonsterInitialization() {
        Monster monster = new Monster(board, null, 1.5f, 10, 100.0f, 0.8f, 15.0f, "gremlin", mainapp);
    ...
    public void testReduceHealth() {
        ...
        Monster monster = new Monster(board, null, 1.0f, 0, 100.0f, 1.0f, 10.0f, "gremlin", null);
    ...
    public void testMonsterSpeed() {
        Board board = new Board();
        Monster monster = new Monster(board, null, 1.5f, 0, 100.0f, 1.0f, 10.0f, "gremlin", null);
        assertEquals(1.5f, monster.getSpeed());
    }
    ...
    public void testMonsterMoveOutside() {
        Monster monster = new Monster(board, null, 1.5f, 0, 100.0f, 1.0f, 10.0f, "gremlin", mainapp);
    ...
    public void testMonsterArmourEffectOnDamage() {
        Monster monster = new Monster(board, null, 1.0f, 0, 100.0f, 0.5f, 10.0f, "gremlin", mainapp);
    ...
    public void testMonsterManaMultiplier() {
        Monster monster = new Monster(board, null, 1.0f, 0, 100.0f, 1.0f, 10.0f, "gremlin", mainapp);
    ...
    public void testMonsterSpeedMovement() {
        Monster monster = new Monster(board, null, 2.0f, 0, 100.0f, 1.0f, 10.0f, "gremlin", mainapp);
        float initialX = monster.getX();
        float initialY = monster.getY();
    ...
    public void testMonsterArmourBoundaries() {
        Monster monster = new Monster(board, null, 1.5f, 0, 100.0f, -0.5f, 10.0f, "gremlin", mainapp); // Negative armour value
        monster.reduceHealth(50.0f);
        assertTrue(monster.getCurrentHp() > 50); // Due to negative armour, the health should decrease by less than 50

        monster = new Monster(board, null, 1.5f, 0, 100.0f, 2.0f, 10.0f, "gremlin", mainapp); // Armour value greater than 1
        monster.reduceHealth(50.0f);
        assertEquals(0.0f, monster.getCurrentHp()); // Monster should be dead as the damage is amplified by the armour

        monster = new Monster(board, null, 1.5f, 0, 100.0f, 1.0f, 10.0f, "gremlin", mainapp); // Exact armour value of 1
        monster.reduceHealth(50.0f);
