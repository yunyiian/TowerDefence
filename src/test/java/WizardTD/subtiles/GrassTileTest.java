...
public class GrassTileTest {
    ...
    public void setUp() {
        app = new TestApplet();
        grassTile = new GrassTile(app);
    }

    @Test
    public void testConstructor() {
        assertNotNull(app.getLastLoadedImagePath(), "Image path should not be null.");
        assertEquals("src/main/resources/WizardTD/grass.png", app.getLastLoadedImagePath(), "Unexpected image path loaded.");
    }

    @Test
    public void testRender() {
        try {
            grassTile.render(5, 10, app);
        } catch (Exception e) {
